...
| 类型 | 标的 |
| --- | --- |
| 自选股 | 德方纳米、新易盛、胜宏科技、汇源通信、恒源煤电、中际旭创、长鑫科技、光莆股份、海光信息 |
...
- 时区固定为 `Asia/Shanghai`。
- 自动化在工作日 09:30—11:30、13:00—15:20 每 5 分钟触发一次（首尾均含）。
- 5 分钟心跳用于档位路由、去重和失败重试，不会把盘中报告频率改成每 5 分钟。
